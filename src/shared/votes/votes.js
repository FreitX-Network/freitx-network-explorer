        ...
        <tbody>
          {votes.map((vote: TVote) => (
            <tr className='bx--parent-row-v2' data-parent-row>
              <td><Link to={`/bonds/${vote.id}`} className='link'>{ellipsisText(vote.id, this.props.width)}</Link></td>
          ...
          {votes.map((vote: TVote) => (
            <tr className='bx--parent-row-v2 tte_group' data-parent-row>
              <td className='single-col-row tte'>
                ...
                <Link to={`/bonds/${vote.id}`} className='link'>{singleColEllipsisText(vote.id, this.props.width, this.props.isHome)}</Link>
              </td>
            </tr>
          ))}
        </tbody>
